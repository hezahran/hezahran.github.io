	...
	$.fn.extend({
		...
		function setBulPos(container,opt) {
			...
			if (opt.navigationArrows!="none" && opt.navigationArrows!="nexttobullets") {
				...
				if (opt.soloArrowLeftHalign=="center")	tl.css({'left':'49%','marginLeft':(opt.soloArrowLeftHOffset-Math.round(tl.innerWidth()/2))+"px"});
				...
				if (opt.soloArrowRightHalign=="center")	tr.css({'left':'49%','marginLeft':(opt.soloArrowRightHOffset-Math.round(tr.innerWidth()/2))+"px"});
			...
			if (opt.navigationHAlign=="center")	bullets.css({'left':'49%','marginLeft':(opt.navigationHOffset-Math.round(bullets.innerWidth()/2))+"px"});
